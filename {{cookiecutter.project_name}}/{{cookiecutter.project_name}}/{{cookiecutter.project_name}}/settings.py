...
WSGI_APPLICATION = '{{cookiecutter.project_name}}.{{cookiecutter.project_name}}.wsgi.application'
...
SIMPLE_JWT = {
    # TODO: Review these settings copied from https://blog.pollithy.com/python/django/react-login-with-django
